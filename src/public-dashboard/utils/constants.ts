...
import { PUBLIC_FULL_TYPING_QUERY_PLACEHOLDER, PUBLIC_FULL_TYPING_QUERY_PLACEHOLDER_WITHOUT_VAR } from '@/utils/fullTypingDateBin';
...
export const FULL_TYPING_QUERY_PLACEHOLDER = PUBLIC_FULL_TYPING_QUERY_PLACEHOLDER;
export const FULL_TYPING_QUERY_PLACEHOLDER_WITHOUT_VAR = PUBLIC_FULL_TYPING_QUERY_PLACEHOLDER_WITHOUT_VAR;
