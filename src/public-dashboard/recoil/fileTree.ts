...
export const gRecentDirectory = atom({
    key: 'publicDashboard_gRecentDirectory',
    default: '/',
});

export const gRecentModalPath = atom({
    key: 'publicDashboard_gRecentModalPath',
    default: '/',
});

export const gRenameFile = atom({
    key: 'publicDashboard_gRename',
    default: undefined,
});

export const gDeleteFileList = atom({
    key: 'publicDashboard_gDeleteFileList',
    default: undefined,
});
...
export const gUpdateFileTree = selector({
    key: 'publicDashboard_gUpdateFileTree',
    get: () => {},
...
export const gDeleteFileTree = selector({
    key: 'publicDashboard_gDeleteFileTree',
    get: () => {},
...
export const gReplaceTree = selector({
    key: 'publicDashboard_gReplaceTree',
    get: () => {},
...
export const gCopyFileTree = selector({
    key: 'publicDashboard_gCopyFileTree',
    get: () => {},
    set: ({ set, get }, newValue: any) => {
