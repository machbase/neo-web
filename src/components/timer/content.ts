...
export const TIMER_SPEC = {
    ...
    rows: [
        ...
        ['Intervals', '@every 1h30m', 'Every hour thirty'],
        ['Predefined schedules', '@daily', 'Every day'],
    ],
};
...
export const AUTO_START_DESC = 'Makes the task start automatically when machbase-neo starts';
