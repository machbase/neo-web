...
import type { TimeBoundaryRangeInput } from './TimeTypes';
 ...
 * @param {TimeBoundaryRangeInput} boardTime - The board time input.
 * @param {TimeBoundaryRangeInput} panelTime - The panel time input.
...
export async function resolveTimeBoundaryRanges<T extends BoundarySeries>(
    seriesConfigSet: T[],
    boardTime: TimeBoundaryRangeInput,
    panelTime: TimeBoundaryRangeInput,
...
function createBoundaryRangePairFromInput(
    baseTimeRange: TimeBoundaryRangeInput,
...
function shouldLoadVirtualStatBounds(baseTimeRange: TimeBoundaryRangeInput): boolean {
    return (
