...
const M_VALUE_ALIAS = 'mValue';
const SUMMVAL_ALIAS = 'SUMMVAL';
const CNTMVAL_ALIAS = 'CNTMVAL';
...
const GROUP_BY_TIME_RESULT_CLAUSE = `${GROUP_BY_KEYWORD} TIME`;
const ORDER_BY_TIME_RESULT_CLAUSE = `${ORDER_BY_KEYWORD} TIME`;
