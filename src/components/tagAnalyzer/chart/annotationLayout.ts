...
import type { ChartAnnotation, ChartSeriesPresentation } from './chartModel';
import { type ChartRow, type ChartSeriesData, type ChartSeriesVisibilityMap } from './chartData';
...
function buildAnnotationAnchors({
    ...
    return annotations.flatMap((annotation, annotationIndex) => {
        ...
        const yAxisIndex = chartSeries?.yAxis ?? seriesInfo.yAxis;
        const annotationAnchorTime = annotation.anchorTime;
