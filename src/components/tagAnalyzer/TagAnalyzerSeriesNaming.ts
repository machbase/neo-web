 ...
 */
export const getSourceTagName = (aItem: SourceTagNameCarrier): string => {
 ...
 */
export const toLegacyTagNameItem = <T extends { sourceTagName?: string }>(aItem: T): T & { tagName: string } => {
    return {
        ...aItem,
 ...
 */
export const toLegacyTagNameList = <T extends { sourceTagName?: string }>(aItems: T[]): Array<T & { tagName: string }> => {
