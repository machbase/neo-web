...
const CompareChart = ({ pChartData, pStartTimeList, pPanelInfo, pAreaChart }: any) => {
    ...
    useEffect(() => {
        setOptions({
            ...
            chart: {
                spacing: [50, 10, 15, 10],
                height: pAreaChart.current.clientHeight - 10,
    ...
    return sOptions && <HighchartsReact highcharts={Highcharts} options={sOptions} />;
};
