# Folder Rename Audit: `src/components/tagAnalyzer/utils`
...
- Decision: Keep type-only files separated when they define shared contracts: `boardTypes.ts`, `panelModelTypes.ts`, `panelRuntimeTypes.ts`.
