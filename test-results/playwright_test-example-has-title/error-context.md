...
- Name: playwright_test\example.spec.ts >> has title
- Location: playwright_test\example.spec.ts:3:1
...
Expected pattern: /web/
Received string:  "Machbase Neo"
Timeout: 5000ms

Call log:
  - Expect "toHaveTitle" with timeout 5000ms
    8 × unexpected value "Machbase Neo"
